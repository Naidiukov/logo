                ...
                $App.connection.select({
                    ...
                    if (res0) {
                        if (res0['name.payerID.personType']) {
                            if (res0['name.payerID.personType'] == 'PHYSICAL') {
                                fieldList.push('physLandPayPurpose', 'physLandPayCode', 'physLandAccount');
                                fromFieldList.push('physLandPayPurpose', 'physLandPayCode', 'physLandAccount')
                            } else {
                                fieldList.push('legLandPayPurpose', 'legLandPayCode', 'legLandAccount');
                                fromFieldList.push('legLandPayPurpose', 'legLandPayCode', 'legLandAccount');
                            }
                        }
                                    ...
                                    buttons: [{
                                        ...
                                        handler: function () {
                                            ...
                                            if (form.isValid()) {
                                                ...
                                                reportParams.address = me.record.get('position') || ''
                                                reportParams.cadastral = me.record.get('cadastralNumber') || ''
                                                if (reportParams.cadastral) reportParams.cadastral = reportParams.cadastral.substring(8)
                                                if (reportParams.cadastral && reportParams.address) reportParams.address += '; '
                                                reportParams.address = reportParams.address + reportParams.cadastral
