exports.reportCode = {
    ...
    buildReport: function (reportParams) {
        ...
        var showEditor = function (html) {
            var htmlToShow = html;//.replace(/відділу відділу/gi, 'відділу');
            // if ((htmlToShow.search('відділу</span></td>') != -1) && (htmlToShow.search('<span style="font-size: 12pt;">Відділу') != -1))
            //     htmlToShow = htmlToShow.replace('<span style="font-size: 12pt;">Відділу ', '<span style="font-size: 12pt;">');
